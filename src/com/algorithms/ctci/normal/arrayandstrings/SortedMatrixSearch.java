...
public class SortedMatrixSearch {
     ...
     * So, we might ask ourselves, what does the unique ordering property of this matrix imply about where an element might be located?
     * We are told that every row and column is sorted. This means that element a[i][j] will be greater
